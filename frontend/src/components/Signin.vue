<template>
  <div class="fixed inset-0 bg-gray-900/80 backdrop-blur-sm flex justify-center items-center z-50">
    <div class="bg-white p-8 rounded-xl w-[90%] max-w-md shadow-xl border border-gray-200">
