<template>
    ...
    <div class="flex justify-between">
      ...
      <button class="text-black mx-10 mt-20 group">
        <router-link class="" to="/highlights">View all&rarr;</router-link>
        <div
    ...
    <div class="py-10 px-10">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <img class="w-full h-52 object-cover rounded-t-2xl" :src="item.image" alt="item.name" />
  ...
  const highlightedItems = ref([
    ...
    },
    {
      id: 6,
      image:
        "https://www.auto-data.net/images/f0/Opel-Astra-G-Caravan.jpg",
      name: "Opel Astra",
      year: "1998",
      people: 4,
      engine: "1.8L Caravan",
